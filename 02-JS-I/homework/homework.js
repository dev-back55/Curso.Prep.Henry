...
function retornarPerimetro(lado){
  ...
  alert("el perimetro es " + perimetro + " m2");
}
...
function areaDelTriangulo(base, altura){
  ...
  alert("el area del triangulo es " + areatri + " m2");
}
...
function deEuroAdolar(euro){
  ...
  var cambiovalordolar = euro * valordolar;
  return cambiovalordolar;
}
